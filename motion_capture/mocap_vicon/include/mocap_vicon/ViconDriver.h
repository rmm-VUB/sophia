...
class ViconDriver: public MoCapDriverBase {
  ...
  private:
    ...
    // Handle the unlabeled markers
    void handleUnlabeledMarkers();

    // Handle the labeled markers
    void handleLabeledMarkers();

    // Handle devices and their output
    void handleDevices();
    ...
    ros::Publisher unlabeled_markers_publisher;
    ros::Publisher labeled_markers_publisher;
    ros::Publisher devices_publisher;
    ros::Time now_time;
